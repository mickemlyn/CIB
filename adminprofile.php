...
<!-- Add all page content inside this div if you want the side nav to push page content to the right (not used if you only want the sidenav to sit on top of the page -->
            <div class="well">
                ...
                <p class="lead text-muted"> Profile Picture</p>
                                        </div>
                        <div class="col-sm-9">
                        <ol class="breadcrumb">
        ...
        <table class="table table-hover table-condensed  table-responsive" >
                ...
                <tr>
                  <td> Some personal info comes here. Your Job post and stuff </td>  
                 </tr>
            </table>    
    ...
    <fieldset>
      <legend class="lead text-muted">Upload New profile Pic</legend>
        <input class="btn btn-file" type="file" id="file" name="file[]" required multiple>
