...
<nav class="navbar  navbar-fixed-top " style="background-color:white;">
    ...
    <div class="content" id="spec">
        <div class="container" style="background-color: rgba(255, 255, 255, 0.3)">
          ...
          <strong>Success! </strong><?php echo $_SESSION['newcatsuccess'];?>
            ...
            <a class="acoddcat" href="#" title="Edit" data-toggle="collapse" data-target="#addcatdiv"><span class="glyphicon glyphicon-plus pull-right" aria-hidden="true"> Add New Category</span></a>
    ...
    <p class="w3-button w3-block w3-dark-grey">&copy; Capital Investments Bank Supplier</p>
                ...
                <a class="acoddsubcat" href="#" title="Edit" data-toggle="collapse" data-target="#addsubcatdiv"><span class="glyphicon glyphicon-plus pull-right" aria-hidden="true"> Add New SubCategory</span></a>
