...
<table id="myTable" class="table table-hover table-condensed table-responsive" >
    ...
    <td>By <a href="#" id="modelc" ><?php echo $data["model"]; ?> </a>
    <p><?php echo $data["itemCategory"]; ?></p>
        </td>
    <td>Kshs. <?php echo $data["price"]; ?></td>

    <?php echo "<td><a  href='#.php?itemId=".$data["itemId"]."' title='Update'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a><br><br>
